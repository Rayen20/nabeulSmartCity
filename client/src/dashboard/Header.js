    ...
    return (
      <div>
        <header className="main-header">
          ...
          <nav className=" navbar-expand-lg navbar-custom fixed-top">
            {/* Sidebar toggle button*/}
            <a href="fake_link" className="sidebar-toggle" data-toggle="push-menu" role="button">
              ...
              <ul className="nav navbar-nav">
                ...
                <li className="dropdown messages-menu">
                  ...
                  <ul className="dropdown-menu">
                    ...
                    <li className="footer"><a href="fake_link">See All Messages</a></li>
                  </ul>
                </li>
                ...
                <li className="dropdown notifications-menu">
                  ...
                  <ul className="dropdown-menu">
                    ...
                    <li className="footer"><a href="fake_link">View all</a></li>
                  </ul>
                </li>
                ...
                <li className="dropdown tasks-menu">
                  ...
                  <ul className="dropdown-menu">
                    ...
                    <li className="footer">
                      <a href="fake_link">View all tasks</a>
                    </li>
                  </ul>
                </li>
                    ...
                    <li className="user-body">
                      <div className="row">
                        <div className="col-xs-4 text-center">
                          <a href="fake_link">Followers</a>
                        </div>
                        <div className="col-xs-4 text-center">
                          <a href="fake_link">Sales</a>
                        </div>
                        <div className="col-xs-4 text-center">
                          <a href="fake_link">Friends</a>
                        </div>
                      </div>
                      {/* /.row */}
                    </li>
                ...
                <li>
                  <a href="fake_link" data-toggle="control-sidebar"><i className="fa fa-gears" /></a>
                </li>
              </ul>
            </div>
          </nav>
